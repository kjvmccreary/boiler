export const API_ENDPOINTS = {
  ...
  PERMISSIONS: {
    ...
    USER_PERMISSIONS: (userId: string) => `/api/permissions/users/${userId}`,
    CHECK_PERMISSION: (userId: string, permission: string) => `/api/permissions/users/${userId}/check/${permission}`,
    CHECK_ANY: (userId: string) => `/api/permissions/users/${userId}/check-any`,
    CHECK_ALL: (userId: string) => `/api/permissions/users/${userId}/check-all`,
