...
public static class MultiTenantWorkflowSeeder
{
    ...
    public static async Task<WorkflowTask> SeedTaskAsync(
        ...
        DTOs.Workflow.Enums.TaskStatus status = DTOs.Workflow.Enums.TaskStatus.Created,
    ...
    public static async Task ForceCancelInstanceAsync(WorkflowDbContext ctx, WorkflowInstance inst)
    {
